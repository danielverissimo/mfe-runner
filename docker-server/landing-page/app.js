...
const SITE_TRANSLATIONS = [
  ...
  ['Node certo para cada projeto', 'Node correcto para cada proyecto', 'The right Node for every project', 'Le bon Node pour chaque projet'],
  ...
  ['Use configuração global, por workspace ou individual, com detecção de .nvmrc e versões instaladas pelo NVM.', 'Use configuración global, por espacio de trabajo o individual, con detección de .nvmrc y versiones instaladas por NVM.', 'Use global, workspace, or per-project settings with .nvmrc detection and NVM-installed versions.', 'Utilisez une configuration globale, par espace ou individuelle, avec détection de .nvmrc et des versions installées par NVM.'],
